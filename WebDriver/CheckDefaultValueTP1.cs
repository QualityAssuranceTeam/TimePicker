...
{
    [TestFixture]
    public class CheckDefaultValueTP1
    {
        ...
        [Test]
        public void TheCheckDefaultValueTP1Test()
        {
            ...
            try
            {
                Assert.AreEqual("19:15", driver.FindElement(By.XPath("//input[contains(@id,'-TP1-inner')]")).GetAttribute("value"));
            }
            catch (AssertionException e)
            {
                verificationErrors.Append(e.Message);
            }
            Console.WriteLine("Default value of TP1 is displayed.");
